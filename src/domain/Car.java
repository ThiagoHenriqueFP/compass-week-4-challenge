...
public class Car extends Vehicle{
    ...
    public Car(String motor, boolean hasSteeringWheel, int passengers, int doors, boolean isHeavyTransport, double carryingCapacity, boolean hasRadio, boolean hasAirConditioner, int year) {
